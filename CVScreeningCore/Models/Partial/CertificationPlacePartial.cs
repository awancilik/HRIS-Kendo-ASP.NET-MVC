...
namespace CVScreeningCore.Models
{
    ...
    public partial class CertificationPlace:QualificationPlace , IEntity
    {
        /// <summary>
        ...
        public override IEnumerable<TypeOfCheckEnum> GetTypeOfChecksCompatible()
        {
            ...
            {
                TypeOfCheckEnum.PROFESSIONNAL_QUALIFICATION_CHECK
            };
        }

        public override QualificationCode GetQualificationCode()
        {
            return QualificationCode.CertificationPlace;
        }
    }
}
