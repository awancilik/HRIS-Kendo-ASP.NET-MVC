...
namespace CVScreeningCore.Models
{
    ...
    public partial class DrivingLicenseCheckingOffice:QualificationPlace , IEntity
    {
        /// <summary>
        ...
        public override IEnumerable<TypeOfCheckEnum> GetTypeOfChecksCompatible()
        {
            ...
            {
                TypeOfCheckEnum.DRIVING_LICENSE_CHECK,
            };
        }

        public override QualificationCode GetQualificationCode()
        {
            return QualificationCode.DrivingLicenseOffice;
        }
    }
}
