...
namespace CVScreeningCore.Models
{
    ...
    public partial class HighSchool:QualificationPlace , IEntity
    {
        /// <summary>
        ...
        public override IEnumerable<TypeOfCheckEnum> GetTypeOfChecksCompatible()
        {
            ...
            {
                TypeOfCheckEnum.EDUCATION_CHECK_STANDARD,
                TypeOfCheckEnum.EDUCATION_CHECK_WITH_EVIDENCE,
            };
        }

        public override QualificationCode GetQualificationCode()
        {
            return QualificationCode.Highschool;
        }
    }
}
